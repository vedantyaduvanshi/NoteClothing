...
<p>We are NOTE, resides at Jaipur-Ajmer Express Highway, Dehmi Kalan, Near GVK Toll Plaza, Jaipur, Rajasthan, Manipal University Jaipur, Jaipur, Rajasthan 303007.</p>

<p>We operate the website https://www.noteclothing.in (the &quot;Site&quot;), as well as any other related products and services that refer or link to these legal terms (the &quot;Legal Terms&quot;) (collectively, the &quot;Services&quot;).</p>

<p>You can contact us by phone at (+91)7266997771, email at note-clothing@outlook.com, or by mail to Jaipur-Ajmer Express Highway, Dehmi Kalan, Near GVK Toll Plaza, Jaipur, Rajasthan, Manipal University Jaipur, Jaipur, Rajasthan 303007, India.</p>

<p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;), and NOTE., concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

<p>We will provide you with prior notice of any scheduled changes to the Services you are using. Changes to Legal Terms will become effective 1 day after the notice is given, except if the changes apply to new functionality, in which case the changes will be effective immediately. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms. If you disagree with such changes, you may terminate Services as per the section &quot;TERM AND TERMINATION.&quot;</p>
...
<p>1. OUR SERVICES 2. INTELLECTUAL PROPERTY RIGHTS 3. USER REPRESENTATIONS 4. USER REGISTRATION 5. PRODUCTS 6. PURCHASES AND PAYMENT 7. RETURN POLICY 8. PROHIBITED ACTIVITIES 9. USER GENERATED CONTRIBUTIONS 10. CONTRIBUTION LICENSE 11. SERVICES MANAGEMENT 12. PRIVACY POLICY 13. TERM AND TERMINATION 14. MODIFICATIONS AND INTERRUPTIONS 15. GOVERNING LAW 16. DISPUTE RESOLUTION 17. CORRECTIONS 18. DISCLAIMER 19. LIMITATIONS OF LIABILITY 20. INDEMNIFICATION 21. USER DATA 22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 23. MISCELLANEOUS 24. CONTACT US</p>
...
<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: aditivashishtha05@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
...
<p>These Legal Terms shall be governed by and defined following the laws of India. NOTE. and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>

<p>16. DISPUTE RESOLUTION</p>

<p>Binding Arbitration</p>

<p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be Jaipur, India. The language of the proceedings shall be English/Hindi. The governing law of these Legal Terms shall be substantive law of India.</p>
...
<p>NOTE. Jaipur-Ajmer Express Highway, Dehmi Kalan, Near GVK Toll Plaza, Jaipur, Rajasthan, Manipal University Jaipur Jaipur, Rajasthan 303007 India Phone: (+91)7266997771 Fax: (+91)7266997771 note-clothing@outlook.com</p>
   <br />
    </div>
    <Footer/>
    </>
